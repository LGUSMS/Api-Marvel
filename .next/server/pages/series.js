(() => {
var exports = {};
exports.id = "pages/series";
exports.ids = ["pages/series"];
exports.modules = {
...
var _jsxFileName = "C:\\Users\\PC-0063739\\Documents\\Consumindo api Marvel\\marvel\\pages\\series.js";
...
function Series() {
  ...
  (0,react__WEBPACK_IMPORTED_MODULE_4__.useEffect)(() => {
    const fetch = async () => {
      if (query === '') {
        const result = await axios__WEBPACK_IMPORTED_MODULE_3___default()(`http://gateway.marvel.com/v1/public/series?ts=1&apikey=fba31148728b53fd9e59a83a3857b523&hash=${hash}`);
        console.log(result.data.data.results);
        setItems(result.data.data.results);
        setLoading(false);
      } else {
        const result = await axios__WEBPACK_IMPORTED_MODULE_3___default()(`http://gateway.marvel.com/v1/public/series?titleStartsWith=${query}&ts=1&apikey=fba31148728b53fd9e59a83a3857b523&hash=${hash}`);
        console.log(result.data.data.results);
        setItems(result.data.data.results);
        setLoading(false);
      }
